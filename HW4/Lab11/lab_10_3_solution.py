...
def div_complex(z1, z2):
    """Return a complex number z1 * z2"""
    return ComplexMA(z1.magnitude*1.0 / z2.magnitude, z1.angle - z2.angle)
###########################################################
...
def div_rational_and_complex(r, z):
    return ComplexMA(( r.numer*1.0 / r.denom)/z.magnitude, 2*pi- z.angle)
